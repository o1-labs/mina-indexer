...
impl IndexerStore {
    ...
    const COLUMN_FAMILIES: [&'static str; 180] = [
        //////////////////////
        // Blocks store CFs //
        //////////////////////
        "blocks",
        ...
        // tokens
        "zkapp-tokens",
        "zkapp-tokens-supply-sort",
        "zkapp-tokens-at-index",
        "zkapp-tokens-index",
        "zkapp-tokens-supply",
        "zkapp-tokens-owner",
        "zkapp-tokens-symbol",
        ...
        "snark-prover-min-fee",
        "snark-prover-min-fee-epoch",
        "snark-prover-min-fee-sort",
